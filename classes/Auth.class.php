...
//    private $db_pass = "";
    ...
    public function __construct($username = null, $password = null)
    {
      ...
      $db_pass = $db_pass_1;
        ...
        $this->connectDb($db_name, $db_user, $db_pass, $db_host);
    }
    ...
    public function create($username, $password, $email, $name1, $surname, $patr) {
        ...
        $query = "insert into users (username, password, salt, email, name, surname, patr)
            values (:username, :password, :salt, :email, :name1, :surname, :patr)";
