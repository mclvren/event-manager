...
<form class="ajax" method="post" action="./ajax.php">
          ...
          <div class="form-actions">
            <p>Вы уже вошли в аккаунт!</p>
              <button class="btn btn-large btn-primary" type="submit">Выйти из аккаунта</button>
          </div>
      </form>
      <?php else: ?>
       <!DOCTYPE html>
...
<body class="">
  ...
  <div class="py-5 bg-dark" style="background-image: url(&quot;assets/img/bg11.jpg&quot;); background-size: cover; background-position: center top;" id="login">
    <div class="container">
      <div class="row my-4">
                  ...
                  <form class="form-signin ajax" method="post" action="./ajax.php">
                    <div class="form-group mb-2">
                      <div class="input-group border-0">
                        ...
                        <input name="username" type="text" class="form-control" id="inlineFormInputGroup1" placeholder="Логин" autocomplete="on"> </div>
                    </div>
                    <div class="form-group mb-2">
                      <div class="input-group border-0">
                        <div class="input-group-prepend">
                        ...
                        <input name="password" type="password" class="form-control" id="inlineFormInputGroup2" placeholder="Пароль" autocomplete="password"> </div>
                    </div>
					<div class="main-error alert alert-error hide"></div>
					<p class="center"><label class="checkbox">
						<input name="remember-me" type="checkbox" value="remember-me" checked> Запомнить
					</label></p>
					<input type="hidden" name="act" value="login">
                    <button type="submit" class="btn mt-4 mb-3 btn-light rounded btn-lg text-primary">Войти</button>
                  </form>
                </div>
              </div>
            </div>
